...
|T4|Remove label(s) from specimen or specimen container. Maintain the sequence of labels for pinned specimens.|Best practice is to keep labels and collection object associated in some way, such as keeping labels and specimen in the same unit tray, stage, or petri dish.  Remember, labels are often **old** and **fragile** and should be handled with care.|Forceps for removing labels. See [SPNHC newsletter 26(2):18](http://www.spnhc.org/media/assets/September2012final.pdf)  Long forceps for removing labels from vials [Bioquip](https://www.bioquip.com/Search/DispProduct.asp?pid=4533)|

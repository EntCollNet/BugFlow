...
|T2| Set aside slides with damaged labels/specimens for conservation workflow. |Re-route slide to conservation workflow per conservation policy. Whether to image labels before conservation depends upon the severity of the damage. Ensure slides are clean and/or in good enough condition for digitization. |Institutional conservation policy|

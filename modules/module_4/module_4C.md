...
|T8|File naming|Rather than using the default machine-generated image numbers, define a standard for naming images, ideally including the catalog number or unique identifier of the specimen. Check if there is already a standard procedure for this at your collection. Skip if your image storage solution handles this for you (see T4).|Free software: [IrfanView](https://www.irfanview.com/), [Inselect](https://naturalhistorymuseum.github.io/inselect/). Script to relabel files from scannable code in image: [Rename from QR](https://github.com/Northover/rename-from-QR). Institutional file-naming protocol|

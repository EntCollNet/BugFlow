...
|T5| Arrange specimen(s)s on photographic jig.| Lighting, positioning, and magnification of specimens is all dependent on the specimen on slide. Check if filters, such as polarization or phase contrast, are necessary to view diagnostic features.|Specimen or label stage or holding apparatus.|

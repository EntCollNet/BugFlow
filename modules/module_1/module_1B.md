...
|T5|Locate and flag the starting point for the day’s imaging.|See Module 1A: Affix labels to rows, cabinets, and/or drawers to facilitate progress tracking.<br>
Starting point and drawer selection is dependent on prioritization activities accomplished at Module 1A.|Institutional policy for methods of tracking digitization progress.|

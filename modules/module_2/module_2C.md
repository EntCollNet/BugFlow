...
|T4|Verify image metadata|Check images to be sure they have all metadata prescribed from imaging tasks in [Module 4](https://github.com/EntCollNet/BugFlow/blob/master/modules/module_4). In particular, verify that catalog numbers or other identifiers used to link file images to specimen records are correct and intact.  If applicable, verify that image formats are acceptable for upload to data repository.|See [Module 4](https://github.com/EntCollNet/BugFlow/blob/master/modules/module_4)|
...
|T9|Assess categories and sources of data errors|Errors should not only be fixed but examined for ways they can be avoided in the future.  Some key items to consider are: (1) updating or reexamining training materials for/with digitization personnel, (2) ammending upstream digitization workflows, (3) ammending physical collection curation to facilitate digitization.||
